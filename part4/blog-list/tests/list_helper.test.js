...
describe('total likes', () => {
	...
	test('when list has many blogs, equals likes of total', () => {
...
describe('total likes', () => {
	...
	test('when list has many blogs, returns author with most blog entries', () => {
		const result = listHelper.mostBlogs(listWithManyBlogs)
		expect(result).toEqual({'author': 'Robert C. Martin', 'blogs': 3})
	})
})

describe('list with many blogs', () => {
	const listWithManyBlogs = [
		{
			_id: '5a422a851b54a676234d17f7',
			title: 'React patterns',
	...
	test('returns author with most likes and number of those likes', () => {
